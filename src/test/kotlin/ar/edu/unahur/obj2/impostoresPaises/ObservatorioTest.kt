 ...
 */
    ...
    class Pais(country: Country) {
        val nombre :String = country.name
        val codigoISo3 : String = country.alpha3Code
        val poblacion : Long = country.population.toLong()
        val continente : String = country.region
        val bloqueRegional : List<RegionalBloc> = country.regionalBlocs
        val idomasOficiales : List<Language> = country.languages
        val capital: String = country.capital
        val paisesLimitrofes: List<String> = country.borders
    }
